...
Namespace Global.PSE
    Friend Class CLR_PSE_NativeLogger
        Inherits TextWriter
        ...
        Private Shared Function __acrt_iob_func(var As UInt16) As IntPtr
        End Function

        <DllImport("ucrtbase.dll", CallingConvention:=CallingConvention.Cdecl)>
        Private Shared Function __stdio_common_vfprintf(_Options As UInt64, _Stream As IntPtr, _Format As Byte(), _Local As IntPtr, _ArgList() As IntPtr) As Int32
        End Function
