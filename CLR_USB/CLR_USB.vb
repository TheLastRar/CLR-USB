...
#If DEBUG Then
    Private Const libraryName As String = "CLR USB Keyboard DEBUG"
#Else
...
#End If
    ...
    Public Shared Sub CreateDevices()
        ...
        Select Case pConfig.Port1SelectedDevice
            Case Config.SelectedDevice.Keyboard
                usb_device1 = New USB_Keyboard(DirectCast(pConfig.Port1Options, Config.ConfigDataKeyboard))
            Case Else
                'already null
        End Select
        ...
        Select Case pConfig.Port2SelectedDevice
            Case Config.SelectedDevice.Keyboard
                usb_device2 = New USB_Keyboard(DirectCast(pConfig.Port2Options, Config.ConfigDataKeyboard))
            Case Else
                'already null
        End Select
    ...
    Private Shared Sub LogInit()
        ...
        CLR_PSE_PluginLog.SetSourceUseStdOut(True, USBLogSources.USBKeyboard) 'Logs NumPad/Caps/Scrool LEDs
        CLR_PSE_PluginLog.SetSourceUseStdOut(False, USBLogSources.OHCI)
        'CLR_PSE_PluginLog.SetLogLevel(SourceLevels.Information, (USBLogSources.USBKeyboard))
    ...
    Public Shared Function Init() As Int32
        Try
            ...
            Dim pluginVer As Version = GetType(CLR_USB).Assembly.GetName().Version
